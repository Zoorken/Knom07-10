...
<form method="post">
	<fieldset>
		...
		<p>
			...
			<br>
			<input type="text" class="text" name="author" value="<?php echo $current['owner']; ?>">
		</p>
		
		<p>
			<label for="input1">Bildlänk (relativ på servern):</label>
			<br>
		...
		<p>
			<label for="input1">Länka till artikel, lämna tom om du ej vill länka:</label>
			<br>
